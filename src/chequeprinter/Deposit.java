...
public final class Deposit extends javax.swing.JDialog {
    ...
    public Deposit(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void InsertToBankStatement() {
        ...
        try {
            ...
            new MessageBox(MessageBox, true, "Deposited Successfully").setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Deposit dialog = new Deposit(new javax.swing.JFrame());
